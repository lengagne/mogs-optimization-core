...
#ifndef __MOGSOPTIMIZATIONPROBLEM__
#define __MOGSOPTIMIZATIONPROBLEM__
...
class MogsOptimizationProblem: public MogsAbstractProblem
{
      public:      

	MogsOptimizationProblem();
