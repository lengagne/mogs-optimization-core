...
class DoubleParameterization : virtual public AbstractParameterization
{
    public:
...
typedef DoubleParameterization* create_DoubleParameterization( );

typedef void destroy_DoubleParameterization(DoubleParameterization*);
