...
#ifndef __NLP_BAD_1_4_HPP__
#define __NLP_BAD_1_4_HPP__
...
class NLP_BAD_1_4:public MogsNlpIpopt
{
      public:
  /** default constructor */
	NLP_BAD_1_4 ();
   ...
   */
	...
	//  NLP_BAD_1_4();
            ...
            NLP_BAD_1_4 (const NLP_BAD_1_4 &);
            NLP_BAD_1_4 & operator= (const NLP_BAD_1_4 &);

            MogsKinematics<double> kin;
            MogsKinematics<B<double> > akin;

            Eigen::Matrix < double,Eigen::Dynamic, 1 > q;
            Eigen::Matrix < B<double> ,Eigen::Dynamic, 1 > aq;

            std::vector < double >qmax;
            std::vector < double >qmin;

            std::vector<AbstractBAD_1_4Critere* >criteres_;
	//@}
};
#endif
